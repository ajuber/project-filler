...
/*   Updated: 2016/08/25 14:37:25 by ajubert          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_coor_piece				*push_back_coor(t_coor_piece *list, char c, int y,
		int x);
...
t_pos						ft_pos_in_map(t_pos repere_map, t_pos repere,
		t_pos var);
...
int							under_other_to(t_e *e, t_pos cir, int *dist_min,
		int dist);
